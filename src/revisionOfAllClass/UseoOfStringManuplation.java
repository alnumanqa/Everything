...
public class UseoOfStringManuplation {
	...
	public static void main(String[] args) {
		...
		// String is immutable means String value can not be changed but we can change
		// the variable value
		...
		System.out.println(s.indexOf('a', s.indexOf('a') + 1)); // find the repetitive character in which
																// index:(s.inDexOf('a', s.inDexof('a')+1));
		System.out.println(s.indexOf('a', s.indexOf('a', s.indexOf('a') + 2) + 1)); // find the repetitive character in
																					// which index:(s.inDexOf('a',
																					// s.inDexof('a')+1));
		...
		// the specified beginIndex and
		// extends to the character at index endIndex - 1. Please remember it, here
		...
		// How to write Array: first data type, then [] called container, student
		// (OBJECT) is the name of Array, [4] represent total 4 data is present
		...
		// System.out.println(characterByCharacter); // This will not show correct
		// outcome, because Arrays class is needed for Array manipulation
		// Arrays is a class, need to import and used to manipulate Array. you can't
		// print Array without help of Arrays class
